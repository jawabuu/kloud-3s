...
module "provider" {
  source = "../../provider/huaweicloud"

  huaweicloud_access_key   = var.huaweicloud_access_key
  huaweicloud_secret_key   = var.huaweicloud_secret_key
  huaweicloud_account_name = var.huaweicloud_account_name
  region                   = var.huaweicloud_region
  region_zone              = var.huaweicloud_region_zone
  size                     = var.huaweicloud_size
  image                    = var.huaweicloud_image
