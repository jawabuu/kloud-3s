...
| huaweicloud\_access\_key | n/a | `string` | `""` | no |
| huaweicloud\_account\_name | n/a | `string` | `""` | no |
| huaweicloud\_image | n/a | `string` | `"Ubuntu 20.04 server 64bit"` | no |
| huaweicloud\_region | n/a | `string` | `"af-south-1"` | no |
| huaweicloud\_region\_zone | n/a | `string` | `"af-south-1a"` | no |
| huaweicloud\_secret\_key | n/a | `string` | `""` | no |
| huaweicloud\_size | n/a | `string` | `"1c1g"` | no |
